...
export function initialize(canvas) {
    const ret = wasm.initialize(canvas);
    return ret;
}
...
export function start_render_loop() {
    const ret = wasm.start_render_loop();
    if (ret[1]) {
...
function __wbg_adapter_24(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h63255d88cc5238c2(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('gpu_acceleration_test_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
