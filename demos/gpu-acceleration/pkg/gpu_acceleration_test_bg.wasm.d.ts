...
export const initialize: (a: any) => any;
export const start_render_loop: () => [number, number];
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h63255d88cc5238c2: (a: number, b: number) => void;
